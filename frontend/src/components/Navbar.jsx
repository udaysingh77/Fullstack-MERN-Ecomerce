...
const Navbar = () => {
  ...
  return <header className="bg-pink-50 fixed w-full z-20 border-b border-pink-200">
    <div className=" max-w-7xl mx-auto flex justify-between items-center py-3">
        ...
        <nav className=" flex gap-10 justify-between items-center">
          ...
          {
            user ? <Button onClick={logoutHandler} className="bg-pink-800 text-white cursor-pointer">Logout</Button> : <Button onClick={()=>navigate("/login")} className="bg-pink-800 text-white cursor-pointer bg-gradient-to-tl from-blue-600 to-purple-600">Login</Button>
          }
        </nav>
    </div>
  </header>;
