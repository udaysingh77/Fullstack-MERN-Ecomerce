                ...
                <div>
                    ...
                    <form className="mt-4 flex">
                        <input
                            ...
                            className="w-full p-2 rounded-l-md border border-gray-300 text-gray-700 bg-white focus:outline-none"
                        />
                        <button
                            type="submit"
                            className="bg-pink-600 text-white px-4 rounded-r-md hover:bg-pink-700 transition"
                        >
                            Subscribe
                        </button>
                    </form>
